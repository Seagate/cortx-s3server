...
./sh/055-create-bg-producer-pod.sh
#./sh/060-check-haproxy-container.sh
#./sh/070-check-authserver-container.sh
./sh/090-check-s3server-container.sh
#./sh/095-check-bg-containers.sh
