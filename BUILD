...
cc_binary(
    ...
    includes = ["third_party/libevent/s3_dist/include/", "third_party/libevhtp/s3_dist/include", "third_party/jsoncpp/dist", "third_party/libxml2/s3_dist/include/libxml2"],
