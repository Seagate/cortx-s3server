...
cc_binary(
    ...
    linkopts = ["-L $(MERO_SRC)/mero/.libs",
                ...
                "-Lthird_party/libxml2/s3_dist/lib third_party/libevhtp/s3_dist/lib/libevhtp.a third_party/gflags/s3_dist/lib/libgflags.a third_party/glog/s3_dist/lib/libglog.a",
...
cc_test(
    ...
    linkopts = ["-L $(MERO_SRC)/mero/.libs",
                ...
                "-pthread third_party/googletest/build/libgtest.a third_party/googlemock/build/libgmock.a third_party/glog/s3_dist/lib/libglog.a",
