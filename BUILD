...
cc_binary(
    ...
    linkopts = [
      "-L $(MERO_LIB)",
      "-L $(MERO_EXTRA_LIB)",
      "-L third_party/libevent/s3_dist/lib/",
      "-L third_party/libevhtp/s3_dist/lib",
      "-L third_party/yaml-cpp/s3_dist/lib",
      "-L third_party/libxml2/s3_dist/lib",
      "-L third_party/gflags/s3_dist/lib",
      "-L third_party/glog/s3_dist/lib",
...
cc_test(
    ...
    linkopts = [
      ...
      "-L third_party/yaml-cpp/s3_dist/lib",
      "-L third_party/libxml2/s3_dist/lib",
      "-L third_party/googletest/build",
      "-L third_party/googlemock/build",
      "-L third_party/glog/s3_dist/lib",
      "-L third_party/gflags/s3_dist/lib",
      "-levhtp -levent -levent_pthreads -levent_openssl -lssl -lcrypto",
      "-lpthread -ldl -lm -lrt -lmero -lgf_complete -laio",
...
cc_binary(
    ...
    linkopts = ["-L third_party/libevent/s3_dist/lib",
                "-L third_party/libevhtp/s3_dist/lib",
                "-L third_party/gflags/s3_dist/lib",
