...
# Copy s3 support bundle files rotation script for retaining newest bundles
cp -f scripts/s3-logrotate/s3supportbundlefilerollover.sh $S3_LOG_ROTATE_FILE_LOCATION
