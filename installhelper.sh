...
cp -f auth/resources/keystorePassword.properties $AUTH_INSTALL_LOCATION/resources/
cp -f auth/resources/authserverPassword.properties $AUTH_INSTALL_LOCATION/resources/
