...
s3_working_dir=$(s3confstore "yaml://$s3_config_file" getkey --key="S3_SERVER_CONFIG>S3_DAEMON_WORKING_DIR")
...
s3_log_dir=$(s3confstore "yaml://$s3_config_file" getkey --key="S3_SERVER_CONFIG>S3_LOG_DIR")
