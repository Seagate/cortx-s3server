...
$USE_SUDO st/clitests/md_integrity.py --body $md_di_data --download $md_di_dowload --parts $md_di_parts --test_plan ./regular_md_integrity.json

# 9. metadata integrity tests - multipart
$USE_SUDO dd if=/dev/urandom of=$md_di_data count=1 bs=5M
$USE_SUDO st/clitests/md_integrity.py --body $md_di_data --download $md_di_dowload --parts $md_di_parts --test_plan ./metadata_md_integrity.json
