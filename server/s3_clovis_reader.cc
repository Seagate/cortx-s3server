...
S3ClovisReader::S3ClovisReader(std::shared_ptr<S3RequestObject> req, std::shared_ptr<ClovisAPI> clovis_api,
      struct m0_uint128 id) : request(req), oid(id), s3_clovis_api(clovis_api),
