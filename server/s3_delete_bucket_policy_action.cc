...
void S3DeleteBucketPolicyAction::setup_steps(){
  ...
  add_task(std::bind( &S3DeleteBucketPolicyAction::send_response_to_s3_client, this ));
  // ...
}
...
void S3DeleteBucketPolicyAction::fetch_bucket_metadata() {
  ...
  bucket_metadata->load(std::bind( &S3DeleteBucketPolicyAction::next, this), std::bind( &S3DeleteBucketPolicyAction::next, this));
