...
const uint64_t g_s3_to_addb_idx_func_name_map_size = 157;
...
const char* g_s3_to_addb_idx_func_name_map[] = {
    ...
    "S3PostCompleteAction::delete_part_index",
    "S3PostCompleteAction::delete_parts",
    ...
    "S3PostMultipartObjectAction::save_multipart_metadata",
