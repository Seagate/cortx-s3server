...
const char* g_s3_to_addb_idx_func_name_map[] = {
    ...
    "MeroGetObjectAction::validate_request",
    "MeroGetObjectAction::read_object",
    "MeroGetObjectAction::send_response_to_s3_client",
    ...
    "MeroPutKeyValueActionTest::func_callback",
