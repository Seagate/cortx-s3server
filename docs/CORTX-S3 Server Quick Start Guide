...
6. You'll need to disable selinux and firewall. Follow the steps below:
    ...
    Once you restart your VM, verify that selinux and firewall are disabled on your VM by using:

    $ getenforce` - you'll get a 'disabled' status.
    ```

7. You'll need to install Lustre. Lustre is an open-source and parallel file system that supports High Performance Computing simulation environments.  
