...
The IP address *192.168.1.10* should also be mapped to *iam.seagate.com* domain
name
...
- addresses returned by DNS server should be consecutive and continuous, e.g.   
    + 192.168.1.1
    + 192.168.1.2
    + 192.168.1.3
    + etc.
- client should belong to the different network
...
Command performs DNS lookups and displays the answers returned.
