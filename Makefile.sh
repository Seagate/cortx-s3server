...
S3SERVER_CPP_SRCS=" $JSONCPP_DIST/jsoncpp.cpp  server/s3_clovis_context.c server/murmur3_hash.cc  server/s3_router.cc server/s3server.cc server/s3_uri.cc server/s3_uri_to_mero_oid.cc server/s3_server_config.cc  server/s3_request_object.cc server/s3_get_bucket_location_action.cc server/s3_get_object_action.cc server/s3_put_object_action.cc server/s3_post_to_main_loop.cc server/s3_object_api_handler.cc server/s3_bucket_api_handler.cc server/s3_clovis_rw_common.cc server/s3_clovis_writer.cc server/s3_clovis_reader.cc server/s3_clovis_config.cc server/s3_asyncop_context_base.cc server/s3_action_base.cc server/s3_md5_hash.cc server/s3_bucket_acl.cc server/s3_bucket_metadata.cc server/s3_object_acl.cc server/s3_object_metadata.cc server/s3_clovis_kvs_reader.cc server/s3_clovis_kvs_writer.cc server/s3_put_bucket_body.cc server/s3_put_bucket_action.cc server/s3_head_bucket_action.cc server/s3_delete_object_action.cc server/s3_service_api_handler.cc server/s3_get_service_action.cc server/s3_service_list_response.cc server/s3_object_list_response.cc server/s3_get_bucket_action.cc server/s3_delete_bucket_action.cc server/s3_head_object_action.cc server/s3_datetime.cc server/s3_error_codes.cc server/s3_error_messages.cc server/s3_auth_client.cc server/s3_auth_context.cc"
...
sudo cp resources/s3_error_messages.json /opt/seagate/s3/resources/s3_error_messages.json
