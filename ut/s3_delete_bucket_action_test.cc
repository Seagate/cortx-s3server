 ...
 protected:
  S3DeleteBucketActionTest() {
    ...
    action_under_test.reset(new S3DeleteBucketAction(
        ...
        object_mp_meta_factory, object_meta_factory, motr_writer_factory,
        motr_kvs_writer_factory, motr_kvs_reader_factory));
  }
...
TEST_F(S3DeleteBucketActionTest, FetchMultipartObjectSuccess) {
  ...
  mymap.insert(std::make_pair(
      ...
      std::make_pair(0,
                     ...
                     "\"file1\",\"motr_oid\":\"AAAAAAAANmU=-AAAAAAAANmU=\","
                     "\"motr_part_oid\":\"AAAAAAAANmU=-AAAAAAAANmU=\"}")));
  mymap.insert(std::make_pair(
      "file2",
      std::make_pair(1,
                     "{\"Bucket-Name\":\"seagate_bucket\",\"Object-Name\":"
                     "\"file2\",\"motr_oid\":\"AAAAAAAANmU=-AAAAAAAANmU=\","
                     "\"motr_part_oid\":\"AAAAAAAANmU=-AAAAAAAANmU=\"}")));
  action_under_test->bucket_metadata =
      bucket_meta_factory->mock_bucket_metadata;
  action_under_test->bucket_metadata->set_multipart_index_oid(oid);
...
TEST_F(S3DeleteBucketActionTest,
  ...
  S3Option::get_instance()->set_motr_idx_fetch_count(1);
  mymap.insert(std::make_pair(
      "file1",
      std::make_pair(0,
                     "{\"Bucket-Name\":\"seagate_bucket\",\"Object-Name\":"
