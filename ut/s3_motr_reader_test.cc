...
<<<<<<< HEAD
  clovis_reader_ptr = std::make_shared<S3MotrReader>(request_mock, oid, 1,
                                                       s3_clovis_api_mock);
=======
  clovis_reader_ptr =
      std::make_shared<S3MotrReader>(request_mock, oid, 1, s3_clovis_api_mock);
...
<<<<<<< HEAD
  clovis_reader_ptr->open_context.reset(new S3MotrReaderContext(
