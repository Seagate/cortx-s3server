...
// **************need to think on errors****************
/*
TEST_F(S3PutBucketReplicationActionTest, ValidateInvalidRequestXmlTags) {
  ...
  MockReplicationConfigStr =
      ...
      "xmlns=\"http://s3.amazonaws.com/doc/2006-03-01/ \">"
      "<Role>Replication_Role</Role><Rule><ID>Rule-1</ID>"
      "<Status>Suspendedrurtryuei</Status>"
      "<Priority>1</Priority><DeleteMarkerReplication>"
      "<Status>Enabled</Status></DeleteMarkerReplication>"
      "</Rule></ReplicationConfiguration>";

  action_under_test_ptr->put_bucket_replication_body =
      bucket_replication_body_factory_mock->create_put_resource_tags_body(
          MockReplicationConfigStr, MockRequestId);
