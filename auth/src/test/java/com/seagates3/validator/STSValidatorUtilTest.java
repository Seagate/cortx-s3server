...
public class STSValidatorUtilTest {
    ...
    public void IsValidName_ValidName_True() {
        ...
        assertTrue(STSValidatorUtil.isValidName(name));
    }
    ...
    public void IsValidName_NameNull_False() {
        String name = null;
        assertFalse(STSValidatorUtil.isValidName(name));
    }
    ...
    public void IsValidDurationSeconds_ValidDuration_True() {
        String duration = "900";
        assertTrue(STSValidatorUtil.isValidDurationSeconds(duration));
    ...
    public void IsValidDurationSeconds_DurationOutOfRange_False() {
        String duration = "850";
        assertFalse(STSValidatorUtil.isValidDurationSeconds(duration));
    ...
    public void IsValidDurationSeconds_InvalidDuration_False() {
        ...
        duration = null;
        assertFalse(STSValidatorUtil.isValidAssumeRoleDuration(duration));
    }
    ...
    public void IsValidPolicy_ValidName_True() {
        String policy = "{\n"
                ...
                + "  ]\n"
                + "}";
        assertTrue(STSValidatorUtil.isValidPolicy(policy));
    }
    ...
    public void IsValidPolicy_NameNull_False() {
        String policy = null;
        assertFalse(STSValidatorUtil.isValidPolicy(policy));
    }
    ...
    public void IsValidAssumeRoleDuration_ValidDuration_True() {
        String duration = "900";
        assertTrue(STSValidatorUtil.isValidAssumeRoleDuration(duration));
    ...
    public void IsValidSAMLAssertion_ValidAssertion_True() {
        ...
        assertTrue(STSValidatorUtil.isValidSAMLAssertion(assertion));
    }
    ...
    public void IsValidSAMLAssertion_AssertionNotEncoded_False() {
        ...
        assertFalse(STSValidatorUtil.isValidSAMLAssertion(assertion));
    }
    ...
    public void IsValidSAMLAssertion_AssertionLengthOutOfRange_False() {
        ...
        assertFalse(STSValidatorUtil.isValidSAMLAssertion(assertionBase64));
