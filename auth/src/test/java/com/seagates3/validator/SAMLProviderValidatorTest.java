...
public class SAMLProviderValidatorTest {
    SAMLProviderValidator validator;
    Map requestBody;

    public SAMLProviderValidatorTest() {
        validator = new SAMLProviderValidator();
    }
    ...
    /**
     * Test SAMLProvider#create.
     * Case - Provider name is null (also tests invalid name).
     */
    @Test
    ...
    /**
     * Test SAMLProvider#create.
     * Case - SAML Metadata is null (also tests for invalid metadata).
     */
    @Test
    ...
    /**
     * Test SAMLProvider#delete.
     * Case - SAML Provider ARN is not provided (also tests for invalid ARN).
     */
    @Test
    ...
    public void Delete_ValidInputs_True() {
        requestBody.put("SAMLProviderArn", "arn:aws:seagate::saml-provider/Test");
        assertTrue(validator.delete(requestBody));
    }

    /**
     * Test SAMLProvider#list.
     * Case - Empty input.
     */
    @Test
    ...
    /**
     * Test SAMLProvider#update.
     * Case - SAML Provider ARN is null (also tests invalid name).
     */
    @Test
