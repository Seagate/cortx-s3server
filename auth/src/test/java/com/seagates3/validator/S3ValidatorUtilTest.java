...
public class S3ValidatorUtilTest {
    /**
     * Test S3ValidatorUtil#isValidName.
     * case - Valid name.
     */
    @Test
    public void IsValidName_ValidName_True() {
        String name = "test.123@seagate.com+=,-";
        assertTrue(S3ValidatorUtil.isValidName(name));
    }
    ...
    public void IsValidName_NameNull_False() {
        String name = null;
        assertFalse(S3ValidatorUtil.isValidName(name));
    }
    ...
    /**
     * Test S3ValidatorUtil#isValidPath.
     * case - Valid path.
     */
    @Test
    public void IsValidPath_ValidPath_True() {
        String path = "/seagate123@/test/";
        assertTrue(S3ValidatorUtil.isValidPath(path));
    ...
    /**
     * Test S3ValidatorUtil#isValidPath.
     * case - Path Length is out of range.
     */
    @Test
    public void IsValidPath_PathLengthOutOfRange_False() {
        ...
        assertFalse(S3ValidatorUtil.isValidName(path));
    }

    /**
     * Test S3ValidatorUtil#isValidPath.
     * case - Invalid Path pattern.
     */
    @Test
    public void IsValidPath_InvalidPathPattern_False() {
        String path = "/seagate/test";
        assertFalse(S3ValidatorUtil.isValidPath(path));
    ...
    /**
     * Test S3ValidatorUtil#isValidMaxItems.
     * case - Max items is in the range.
     */
    @Test
    public void IsValidMaxItems_ValidMaxItems_True() {
        String maxitems = "100";
        assertTrue(S3ValidatorUtil.isValidMaxItems(maxitems));
    }

    /**
     * Test S3ValidatorUtil#isValidMaxItems.
     * case - Max items is outside the range.
     */
    @Test
    public void IsValidMaxItems_MaxItemsOutOfRange_False() {
        String maxitems = "10000";
        assertFalse(S3ValidatorUtil.isValidMaxItems(maxitems));
    ...
    /**
     * Test S3ValidatorUtil#isValidMaxItems.
     * case - Max items is not an integer.
     */
    @Test
    ...
    /**
     * Test S3ValidatorUtil#isValidPathPrefix.
     * case - Valid path prefix.
     */
    @Test
    public void IsValidPathPrefix_ValidPathPrefix_True() {
        String path = "/seagate123@/test";
        assertTrue(S3ValidatorUtil.isValidPathPrefix(path));
    ...
    /**
     * Test S3ValidatorUtil#isValidPathPrefix.
     * case - Path prefix Length is out of range.
     */
    @Test
    public void IsValidPathPrefix_PathLengthOutOfRange_False() {
        String str = new String(new char[600]).replace('\0', '/');
        String path = String.format("/%s/", str);
        assertFalse(S3ValidatorUtil.isValidPathPrefix(path));
    }

    /**
     * Test S3ValidatorUtil#isValidPath.
     * case - Invalid path prefix pattern.
     */
    @Test
    ...
    /**
     * Test S3ValidatorUtil#isValidMarker.
     * case - Valid marker.
     */
    @Test
    public void IsValidMarker_ValidMarker_True() {
        String marker = "test";
        assertTrue(S3ValidatorUtil.isValidMarker(marker));
    }

    /**
     * Test S3ValidatorUtil#isValidMarker.
     * case - Marker Length is out of range.
     */
    @Test
    public void IsValidMarker_MarkerLengthOutOfRange_False() {
        String marker = new String(new char[350]).replace('\0', 'a');
        assertFalse(S3ValidatorUtil.isValidMarker(marker));
    }

    /**
     * Test S3ValidatorUtil#isValidMarker.
     * case - Invalid Marker pattern.
     */
    @Test
    ...
    /**
     * Test S3ValidatorUtil#isValidAccessKeyUserName.
     * case - Valid name.
     */
    @Test
    ...
    /**
     * Test S3ValidatorUtil#isValidAccessKeyId.
     * case - Valid access key id.
     */
    @Test
    public void IsValidAccessKeyId_ValidAccessKeyId_True() {
        String accessKeyId = "ABCDEFGHIJKLMN123456";
        assertTrue(S3ValidatorUtil.isValidAccessKeyId(accessKeyId));
    }

    /**
     * Test S3ValidatorUtil#isValidAccessKeyId.
     * case - Access key id is null
     */
    @Test
    public void IsValidAccessKeyId_NameNull_False() {
        String accessKeyId = null;
        assertFalse(S3ValidatorUtil.isValidAccessKeyId(accessKeyId));
    }

    /**
     * Test S3ValidatorUtil#isValidAccessKeyId.
     * case - Invalid access key id pattern.
     */
    @Test
    ...
    /**
     * Test S3ValidatorUtil#isValidAccessKeyId.
     * case - Length of the access key id is out of range.
     */
    @Test
    ...
    /**
     * Test S3ValidatorUtil#isValidAccessKeyStatus.
     * case - Valid access key id.
     */
    @Test
    public void IsValidAccessKeyStatus_ValidAccessKeyStatus_True() {
        String status = "Active";
        assertTrue(S3ValidatorUtil.isValidAccessKeyStatus(status));
    ...
    public void IsValidAccessKeyStatus_AccessKeyStatusNull_False() {
        String status = null;
        assertFalse(S3ValidatorUtil.isValidAccessKeyStatus(status));
    }
    ...
    /**
     * Test S3ValidatorUtil#isValidAssumeRolePolicyDocument.
     * case - Valid policy document.
     */
    @Test
...
"  }\n" +
"}";
        assertTrue(S3ValidatorUtil.isValidAssumeRolePolicyDocument(policyDoc));
    }
    ...
    public void IsValidAssumeRolePolicyDoc_NameNull_False() {
        ...
        assertFalse(S3ValidatorUtil.isValidAssumeRolePolicyDocument(policyDoc));
    }

    /**
     * Test S3ValidatorUtil#isValidAssumeRolePolicyDocument.
     * case - Policy doc has invalid characters.
     */
    @Test
    ...
    /**
     * Test S3ValidatorUtil#isValidAssumeRolePolicyDocument.
     * case - Length of policy document is out of range.
     */
    @Test
    ...
    /**
     * Test S3ValidatorUtil#isValidSamlProviderName.
     * case - Valid name.
     */
    @Test
    public void IsValidSamlProviderName_ValidName_True() {
        String name = "test123._-";
        assertTrue(S3ValidatorUtil.isValidSamlProviderName(name));
    }
    ...
    public void IsValidSamlProviderName_NameNull_False() {
        String name = null;
        assertFalse(S3ValidatorUtil.isValidSamlProviderName(name));
    }
    ...
    /**
     * Test S3ValidatorUtil#isValidSAMLMetadata.
     * case - Valid SAML metadata.
     */
    @Test
    public void IsValidSamlMetadata_ValidName_True() {
        String metadata = new String(new char[1000]).replace('\0', 'a');
        assertTrue(S3ValidatorUtil.isValidSAMLMetadata(metadata));
    }
    ...
    public void IsValidSamlMetadata_NameNull_False() {
        ...
        assertFalse(S3ValidatorUtil.isValidSAMLMetadata(metadata));
    }
    ...
    public void IsValidARN_ARNIsNULL_False() {
        String arn = null;
        assertFalse(S3ValidatorUtil.isValidARN(arn));
    }

    /**
     * Test S3ValidatorUtil#isValidARN.
     * case - ARN length out of range.
     */
    @Test
    public void IsValidARN_InvalidARN_False() {
        String duration = "abc";
        assertFalse(S3ValidatorUtil.isValidARN(duration));
