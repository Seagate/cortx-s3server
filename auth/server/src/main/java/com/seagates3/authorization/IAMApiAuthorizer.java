...
public class IAMApiAuthorizer {

    private static final Logger LOGGER = LoggerFactory.getLogger(
        IAMApiAuthorizer.class.getName());
     ...
     */
    public void authorize(Requestor requestor, Map<String, String> requestBody)
     ...
     *
     */
    public Boolean validateIfUserCanPerformAction(Requestor requestor,
     ...
     */
    private static Boolean hasRootUserCredentials(Requestor requestor) {
     ...
     */
    private static Boolean isSameUser(Map<String, String> requestBody, Requestor
        requestor) {
