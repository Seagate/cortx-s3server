...
public class AccountResponseGenerator extends AbstractResponseGenerator {
  ...
  public
   ServerResponse generateCreateResponse(Account account, User root,
  ...
  public
   ServerResponse generateListResponse(Object[] responseObjects,
     ...
     ArrayList<LinkedHashMap<String, String>> accountMembers =
         new ArrayList<>();
  ...
  public
   ServerResponse generateResetAccountAccessKeyResponse(
       Account account, User root, AccessKey rootAccessKey) {
     LinkedHashMap responseElements = new LinkedHashMap();
     responseElements.put("AccountId", account.getId());
     responseElements.put("CanonicalId", account.getCanonicalId());
     responseElements.put("AccountName", account.getName());
   ...
   @Override public ServerResponse entityAlreadyExists() {
  ...
  ServerResponse accessKeyAlreadyExists() {
    ...
    return formatResponse(HttpResponseStatus.CONFLICT, "AccessKeyAlreadyExists",
                          errorMessage);
  }
