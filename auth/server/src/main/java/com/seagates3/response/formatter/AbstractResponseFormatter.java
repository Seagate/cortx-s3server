...
public abstract class AbstractResponseFormatter {
    ...
    public abstract ServerResponse formatCreateResponse(String operation,
    ...
    public abstract ServerResponse formatListResponse(String operation,
            String returnObject,
            ArrayList<LinkedHashMap<String, String>> responseElements,
            Boolean isTruncated, String requestId);

    public abstract ServerResponse formatErrorResponse(
