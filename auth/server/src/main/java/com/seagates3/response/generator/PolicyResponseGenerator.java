...
public
class PolicyResponseGenerator extends AbstractResponseGenerator {

 public
  ServerResponse generateCreateResponse(Policy policy) {
 ...
 public
  ServerResponse generateGetResponse(Policy policy) {
    ...
    return new XMLResponseFormatter().formatGetResponse(
        "ListPolicies", "Policies", policyMembers, AuthServerConfig.getReqId());
  }
}
