...
public class KeyGenUtil {
  ...
  private
   static final Logger LOGGER =
       LoggerFactory.getLogger(KeyGenUtil.class.getName());
  private
   static final int SALT_LENGTH = 4;
  private
   static final String S3CIPHER_GENERATE_KEY_CMD =
       "s3cipher generate_key --const_key ";
    /*
     * TODO
   ...
   public
    static String generateKeyByS3CipherUtil(String constKey)
        throws IOException {
      ...
      try {
        ...
        LOGGER.error(
            "Error occurred while generating key using s3cipher util. Cause: " +
