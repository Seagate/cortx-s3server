...
public
class UserPolicyImpl implements UserPolicyDAO {

 private
  static final String USER_POLICY_PREFIX = "UserPolicy";

  @Override public void attach(UserPolicy userPolicy)
  ...
  @Override public void detach(UserPolicy userPolicy)
      throws DataAccessException {
    AuthStore storeInstance = getAuthStoreInstance();
    Map userPolicyDetailsMap = new HashMap<>();
    userPolicyDetailsMap.put("", userPolicy);
 ...
 private
  AuthStore getAuthStoreInstance() {
