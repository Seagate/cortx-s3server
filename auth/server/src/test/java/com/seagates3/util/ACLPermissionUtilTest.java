...
public class ACLPermissionUtilTest {
    ...
    public void testGetACLPermission() {
        ...
        // List bucket
        assertTrue(ACLPermissionUtil.getACLPermission(HttpMethod.GET,
                "/bkirunge") == ACLPermissionUtil.ACL_READ);
        ...
        assertTrue(ACLPermissionUtil.getACLPermission(HttpMethod.GET,
                "/bkirunge/test.txt") == ACLPermissionUtil.ACL_READ);
        ...
        assertTrue(ACLPermissionUtil.getACLPermission(HttpMethod.PUT,
                "/bkirunge") == ACLPermissionUtil.ACL_WRITE);

        // Upload object in bucket
        assertTrue(ACLPermissionUtil.getACLPermission(HttpMethod.PUT,
                "/bkirunge/test.txt") == ACLPermissionUtil.ACL_WRITE);

        // POST object
        assertTrue(ACLPermissionUtil.getACLPermission(HttpMethod.POST,
                "/bkirunge/test.txt") == ACLPermissionUtil.ACL_WRITE);
        ...
        // List bucket ACL
        assertTrue(ACLPermissionUtil.getACLPermission(HttpMethod.GET,
                "/bkirunge?acl") == ACLPermissionUtil.ACL_READ_ACP);

        // Get Object ACL
        assertTrue(ACLPermissionUtil.getACLPermission(HttpMethod.GET,
                "/bkirunge/test.txt?acl") == ACLPermissionUtil.ACL_READ_ACP);

        // Add bucket ACL
        assertTrue(ACLPermissionUtil.getACLPermission(HttpMethod.PUT,
                "/bkirunge?acl") == ACLPermissionUtil.ACL_WRITE_ACP);

        // Add object ACL
        assertTrue(ACLPermissionUtil.getACLPermission(HttpMethod.PUT,
                "/bkirunge/test.txt?acl") == ACLPermissionUtil.ACL_WRITE_ACP);
