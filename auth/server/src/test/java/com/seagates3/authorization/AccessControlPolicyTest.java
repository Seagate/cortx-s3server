...
public class AccessControlPolicyTest {
    ...
    String acpXmlString = "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"no\"?>" +
    ...
    " xsi:type=\"CanonicalUser\">" +
    "    <ID>Int4</ID>" +
    "    <DisplayName>Stringe</DisplayName>" +
    "   </Grantee>" +
    "   <Permission>String3</Permission>" +
    "  </Grant>" +
    "  <Grant>" +
    "   <Grantee xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\"" +
    " xsi:type=\"CanonicalUser\">" +
    ...
    @Test
    public void setOwnerDisplayName_Test() {
        Owner owner = new Owner("123", "abc");
        accessControlPolicy.setOwner(owner);
        owner = accessControlPolicy.getOwner();
   ...
   @Test public void nodeGrantListGreaterThanLocalACLGrantList_Test()
       ...
       String acp = "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"no\"?>" +
                "<AccessControlPolicy xmlns=\"http://s3.amazonaws.com/doc/2006-03-01/\">" +
                " <Owner>" +
                "  <ID>123er45678</ID>" +
                "  <DisplayName>S3test</DisplayName>" +
                ...
                " xsi:type=\"CanonicalUser\">" +
                "    <ID>id0</ID>" +
                "    <DisplayName>abc0</DisplayName>" +
                "   </Grantee>" +
                "   <Permission>permission0</Permission>" +
                "  </Grant>   " +
                "    </AccessControlList>" +
                "</AccessControlPolicy>";
       try {
