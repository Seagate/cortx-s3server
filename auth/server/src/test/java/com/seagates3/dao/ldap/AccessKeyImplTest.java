...
@RunWith(PowerMockRunner.class)
    @PrepareForTest({LDAPUtils.class,             AccessKeyImpl.class,
                     ...
                     AuthServerConfig.class,      AESEncryptDecryptUtil.class})
    @PowerMockIgnore({"javax.management.*"}) public class AccessKeyImplTest {

 private
  final String ACCESSKEY_BASE_DN = "ou=accesskeys,dc=s3,dc=seagate," + "dc=com";
 private
  final String[] FIND_ATTRS = {"s3userid",   "sk",     "exp",
                               "token",      "status", "createtimestamp",
                               "objectclass"};

 private
  final String[] FIND_ALL_ATTRS = {"ak", "status", "createtimestamp", "token"};

 private
  final String[] GETCOUNT_ATTRS = {"ak", "exp"};

 private
  final String LDAP_DATE;
 private
  final String EXPECTED_DATE;

 private
  final AccessKeyImpl accesskeyImpl;
 private
  final LDAPSearchResults ldapResults;
 private
  final LDAPEntry entry;
 private
  final LDAPAttribute accountIdAttr;
 private
  final LDAPAttribute accessKeyIdAttr;
 private
  final LDAPAttribute userIdAttr;
 private
  final LDAPAttribute secretKeyAttr;
 private
  final LDAPAttribute statusAttr;
 private
  final LDAPAttribute createTimeStampAttr;
 private
  final LDAPAttribute objectClassAttr;
 private
  final LDAPAttribute expiryAttr;
 private
  final LDAPAttribute tokenAttr;
 private
 ...
 private
  void setupAccessKeyAttr() throws Exception {
    ...
    PowerMockito.when(AESEncryptDecryptUtil.class, "decrypt",
                      Mockito.any(String.class), Mockito.any(String.class))
        .thenReturn("decrypted-sk-123/test");
    Mockito.when(entry.getAttribute("sk")).thenReturn(secretKeyAttr);
    Mockito.when(secretKeyAttr.getStringValue())
        .thenReturn("encrypted-sk-123/test");
  ...
  @Test public void Find_AccessKeySearchFailed_ThrowException()
      throws Exception {
  ...
  @Test(expected = DataAccessException
                       .class) public void Find_AccessKey_ThrowException()
      throws Exception {
    String filter = "ak=AKIATEST";
  ...
  @Test public void Find_AccessKeyNotFound_ReturnEmptyAccessKey()
      throws Exception {
  ...
  @Test public void findAccessKeyFoundReturnAccessKey() throws Exception {
    AccessKey expectedAccessKey = new AccessKey();
    expectedAccessKey.setId("AKIATEST");
    ...
    PowerMockito.doReturn(ldapResults).when(
        LDAPUtils.class, "search", ACCESSKEY_BASE_DN, 2, filter, FIND_ATTRS);
    PowerMockito.doReturn(ldapResults).when(ldapConnection).search(
        ACCESSKEY_BASE_DN, 2, filter, FIND_ATTRS, false);
  ...
  @Test public void findFedAccessKeyFoundReturnAccessKey() throws Exception {
    AccessKey expectedAccessKey = new AccessKey();
    expectedAccessKey.setId("AKIATEST");
    expectedAccessKey.setUserId("123");
    expectedAccessKey.setSecretKey("decrypted-sk-123/test");
  ...
  @Test public void FindAll_AccessKeySearchFailed_ThrowException()
      throws Exception {
    User user = new User();
    user.setId("123");
  ...
  @Test public void FindAll_AccessKeyEmpty_ReturnEmptyList() throws Exception {
  ...
  @Test public void FindAll_AccessKeyIterationFailed_ThrowException()
      throws Exception {
    User user = new User();
    user.setId("123");
  ...
  @Test public void FindAll_AccessKeyFound_ReturnList() throws Exception {
    setupAccessKeyAttr();
  ...
  @Test public void GetCount_AccessKeySearchFailed_ThrowException()
      throws Exception {
    String filter = "(&(s3userid=123)(objectclass=accesskey))";
    PowerMockito.doThrow(new LDAPException()).when(LDAPUtils.class, "search",
                                                   ACCESSKEY_BASE_DN, 2, filter,
  ...
  @Test public void GetCount_ExceptionOccuredWhileIterating_ThrowException()
      throws Exception {
    String filter = "(&(s3userid=123)(objectclass=accesskey))";
    exception.expect(DataAccessException.class);
  ...
  @Test public void GetCount_NoAccessKey_ReturnZero() throws Exception {
    String filter = "(&(s3userid=123)(objectclass=accesskey))";
  ...
  @Test public void GetCount_HasTwoAccessKeys_ReturnTwo() throws Exception {
    String filter = "(&(s3userid=123)(objectclass=accesskey))";
  ...
  @Test public void HasAccessKeys_NoAccessKey_ReturnFalse() throws Exception {
    String filter = "(&(s3userid=123)(objectclass=accesskey))";
  ...
  @Test public void HasAccessKeys_HasAccessKeys_ReturnTrue() throws Exception {
    String filter = "(&(s3userid=123)(objectclass=accesskey))";
  ...
  @Test public void Delete_AccessKeyDeleteFailed_ThrowException()
      throws Exception {
  ...
  @Test public void Delete_AccessKeyDeleted() throws Exception {
    AccessKey accessKey = new AccessKey();
    accessKey.setId("AKIATEST");
  ...
  @Test public void saveAccessKeySaveFailedThrowException() throws Exception {
    AccessKey accessKey = new AccessKey();
    ...
    PowerMockito.doThrow(new LDAPException())
        .when(LDAPUtils.class, "add", Matchers.any(LDAPEntry.class));

    PowerMockito.when(AESEncryptDecryptUtil.class, "encrypt",
                      Mockito.any(String.class), Mockito.any(String.class))
  ...
  @Test public void saveAccessKeySaved() throws Exception {
    AccessKey accessKey = new AccessKey();
    accessKey.setUserId("123");
    accessKey.setId("AKIATEST");
    accessKey.setSecretKey("s3-1232/test");
    ...
    PowerMockito.whenNew(LDAPAttributeSet.class).withNoArguments().thenReturn(
        ldapAttributeSet);
    ...
    PowerMockito.verifyNew(LDAPAttribute.class)
        .withArguments("sk", "encrypted-s3-1232/test");
    PowerMockito.verifyNew(LDAPAttribute.class)
  ...
  @Test public void saveFedAccessKeySaveFailedThrowException()
      throws Exception {
    AccessKey accessKey = new AccessKey();
    accessKey.setUserId("123");
    accessKey.setId("AKIATEST");
  ...
  @Test public void saveFedAccessKeySaved() throws Exception {
    AccessKey accessKey = new AccessKey();
    accessKey.setUserId("123");
    accessKey.setId("AKIATEST");
    accessKey.setSecretKey("s3-1232/test");
  ...
  @Test public void Update_AccessKeyModifyFailed_ThrowException()
      throws Exception {
    AccessKey accessKey = new AccessKey();
    accessKey.setId("AKIATEST");
    ...
    String dn = "ak=AKIATEST,ou=accesskeys,dc=s3,dc=seagate,dc=com";
    PowerMockito.doThrow(new LDAPException())
        .when(LDAPUtils.class, "modify", dn, modification);
  ...
  @Test public void UpdateUser_UserModifySuccess() throws Exception {
    AccessKey accessKey = new AccessKey();
    accessKey.setId("AKIATEST");
  ...
  @Test public void findFromTokenAccessKeyFoundReturnAccessKey()
      throws Exception {
    AccessKey expectedAccessKey = new AccessKey();
    expectedAccessKey.setUserId("123");
    expectedAccessKey.setSecretKey("decrypted-sk-123/test");
  ...
  @Test public void FindFromToken_AccessKeyNotFound_ReturnEmptyAccessKey()
      throws Exception {
    AccessKey expectedAccessKey = new AccessKey();
    expectedAccessKey.setToken("AWS_SEC_TOKEN");
  ...
  @Test(expected =
            DataAccessException
                .class) public void FindFromToken_SearchShouldTrowException()
      throws Exception {
    String filter = "token=AWS_SEC_TOKEN";
    String[] attrs = {LDAPUtils.USER_ID,     LDAPUtils.SECRET_KEY,
                      LDAPUtils.EXPIRY,      LDAPUtils.ACCESS_KEY_ID,
  ...
  @Test(expected =
            DataAccessException
                .class) public void FindFromToken_GetEntryShouldThrowException()
      throws Exception {
    String filter = "token=AWS_SEC_TOKEN";
    String[] attrs = {LDAPUtils.USER_ID,     LDAPUtils.SECRET_KEY,
                      LDAPUtils.EXPIRY,      LDAPUtils.ACCESS_KEY_ID,
  ...
  @Test public void findFromTokenFedAccessKeyFoundReturnAccessKey()
      throws Exception {
    AccessKey expectedAccessKey = new AccessKey();
    expectedAccessKey.setId("AKIATEST");
    expectedAccessKey.setUserId("123");
  ...
  @Test public void findAccountAccessKeySuccess() throws Exception {
    User user = new User();
    user.setId("123");
    String filter = "(&(s3userid=123)(objectclass=accesskey))";
