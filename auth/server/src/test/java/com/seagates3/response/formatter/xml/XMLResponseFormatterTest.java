 ...
 */
public class XMLResponseFormatterTest {
    ...
    public void testFormatCreateResponse() {
        ...
        ServerResponse response = new XMLResponseFormatter().formatCreateResponse("CreateUser",
    ...
    @Test
    public void testFormatDeleteResponse() {
        final String expectedResponseBody = "<?xml version=\"1.0\" "
                + "encoding=\"UTF-8\" standalone=\"no\"?>"
                + "<DeleteUserResponse xmlns=\"https://iam.seagate.com/doc/2010-05-08/\">"
                + "<ResponseMetadata>"
                + "<RequestId>0000</RequestId>"
                + "</ResponseMetadata>"
                + "</DeleteUserResponse>";

        ServerResponse response = new XMLResponseFormatter().formatDeleteResponse("DeleteUser");
    ...
    public void testFormatUpdateResponse() {
        final String expectedResponseBody = "<?xml version=\"1.0\" "
                + "encoding=\"UTF-8\" standalone=\"no\"?>"
                + "<UpdateUserResponse xmlns=\"https://iam.seagate.com/doc/2010-05-08/\">"
                + "<ResponseMetadata>"
                + "<RequestId>0000</RequestId>"
                + "</ResponseMetadata>"
                + "</UpdateUserResponse>";

        ServerResponse response = new XMLResponseFormatter().formatUpdateResponse("UpdateUser");
    ...
    public void testFormatListResponse() {
        ...
        final String expectedResponseBody = "<?xml version=\"1.0\" "
                ...
                + "<member>"
                + "<Path>/</Path>"
                + "<UserName>s3test1</UserName>"
                + "<UserId>123</UserId>"
                + "<Arn>arn:123</Arn>"
                + "</member>"
                + "<member>"
                + "<Path>/test/</Path>"
                + "<UserName>s3test2</UserName>"
                + "<UserId>456</UserId>"
                + "<Arn>arn:456</Arn>"
                + "</member>"
                + "</Users>"
        ...
        ServerResponse response = new XMLResponseFormatter().formatListResponse("ListUsers",
                "Users", userMemebers, false, "9999");
