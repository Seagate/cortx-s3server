...
static int init_clovis(void) {
  ...
  motr_conf.mc_local_addr = FLAGS_clovis_local_addr.c_str();
  motr_conf.mc_ha_addr = FLAGS_clovis_ha_addr.c_str();
  motr_conf.mc_profile = FLAGS_clovis_profile.c_str();
  motr_conf.mc_process_fid = FLAGS_clovis_proc.c_str();
...
static void fini_clovis(void) { m0_client_fini(motr_instance, true); }
