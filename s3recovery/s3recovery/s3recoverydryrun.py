...
class S3RecoveryDryRun:
    ...
    def dry_run(self, index_name, index_id, index_id_replica):
        ...
        self.print_recovered_data(index_name, data_to_restore)

    def start(self):

        self.dry_run("global_bucket_index_id", Config.global_bucket_index_id, Config.global_bucket_index_id_replica)
        self.dry_run("bucket_metadata_index_id", Config.bucket_metadata_index_id, Config.bucket_metadata_index_id_replica)
