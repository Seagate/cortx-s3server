...
if __name__ == "__main__":
    ...
    # Fetch the list of kv entries
    # Get the count of kv entries
    # Compare threshold value(if passed by user) and total count of kv entries, raise IEM alert if count of kv entries exceeds threshold value and exit immediately
    def countkv():
